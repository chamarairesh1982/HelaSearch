...
CREATE INDEX idx_text_chunks_file_id ON public.text_chunks(file_id);
CREATE INDEX idx_text_chunks_embedding ON public.text_chunks USING ivfflat (embedding vector_cosine_ops);
